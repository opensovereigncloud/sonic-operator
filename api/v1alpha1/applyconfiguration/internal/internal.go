...
- name: com.github.ironcore-dev.sonic-operator.api.v1alpha1.SwitchInterface
  map:
    ...
    - name: spec
      type:
        namedType: com.github.ironcore-dev.sonic-operator.api.v1alpha1.SwitchInterfaceSpec
    - name: status
      type:
        namedType: com.github.ironcore-dev.sonic-operator.api.v1alpha1.SwitchInterfaceStatus
- name: com.github.ironcore-dev.sonic-operator.api.v1alpha1.SwitchInterfaceSpec
  map:
    fields:
    - name: adminState
      type:
...
- name: com.github.ironcore-dev.sonic-operator.api.v1alpha1.SwitchInterfaceState
  scalar: string
- name: com.github.ironcore-dev.sonic-operator.api.v1alpha1.SwitchInterfaceStatus
  map:
    fields:
    - name: adminState
      type:
    ...
    - name: neighbor
      type:
        namedType: com.github.ironcore-dev.sonic-operator.api.v1alpha1.Neighbor
